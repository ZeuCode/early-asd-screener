...
/* export default function ChildCard({ child }: { child: ChildResume }) {
  ...
  return (
    <div
      onClick={goToDetails}
      className="cursor-pointer bg-white dark:bg-gray-900 shadow rounded-xl p-4 border border-gray-200 dark:border-gray-700 space-y-2 hover:shadow-md dark:hover:shadow-lg transition-colors duration-300"
    >
