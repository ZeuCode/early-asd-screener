...
//       navigate(-1); // o a `/children/:childId/evaluations` si prefieres
//     } catch (error: any) {
//       const message =
...
//           {/* separador opcional si quieres alinearlo al final */}
//           <button
//             onClick={() => setShowConfirmModal(true)}
//             disabled={isDeleting}
//             className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-4 py-2 rounded-lg shadow disabled:opacity-50"
//           >
...
//             handleDelete(); // Ejecuta tu lógica ya implementada
//           }}
//         />
//       )}
//     </div>
